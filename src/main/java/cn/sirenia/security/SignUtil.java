...
public class SignUtil {
    ...
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
        ...
        KeyStore ks = org.jsirenia.security.KeyStoreUtil.loadKeyStore(ksfile, "xxx", "JKS");//JKS:java keystore
        PrivateKey privateKey = org.jsirenia.security.RSAUtil.getPrivateKey(ks, "xxx", "xxx");
        String sign = SignUtil.signBase64("my precious".getBytes("utf-8"), privateKey);

        PublicKey publicKey = org.jsirenia.security.RSAUtil.getPublicKey(ks, "xxx", "xxx");
        ...
        Certificate cert = org.jsirenia.security.CertUtil.loadCertificate(cerfile);
